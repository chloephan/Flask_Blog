...
def register():
	...
	if form.validate_on_submit():
		...
		db.session.add(user)
		db.session.commit()
		flash(f'Your account has been created! You are now log in  {form.username.data}!', 'success')
...
def send_reset_email(user):
	...
	If you did not make the request then ignore this email and no changes will be made
...
def reset_token(token):
	...
	if form.validate_on_submit():
		...
		db.session.commit()
		flash(f'Your account has been update! You are now log in  {form.username.data}!', 'success')
		return redirect(url_for('login'))
